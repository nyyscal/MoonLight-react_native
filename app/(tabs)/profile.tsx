...
const Profile = () => {
  ...
  const [editedProfile,setIsEditedProfile] = useState({
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios"? "padding":"height"} style={styles.modalContainer}>
              <View style={styles.modalContent}>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <TextInput style={styles.input} value={editedProfile.fullname} onChangeText={(text)=>setIsEditedProfile((prev)=>({...prev,fullname:text}))}
                ...
                <View style={styles.inputContainer}>
                  ...
                  <TextInput style={[styles.input,styles.bioInput]} value={editedProfile.bio} onChangeText={(text)=>setIsEditedProfile((prev)=>({...prev,bio:text}))} multiline numberOfLines={4} 
                    placeholderTextColor={COLORS.grey}
                    />
                </View>
